...
TEST(instruction_construction, make_instruction_basic_instruction_fields_are_set) {
    instruction *instruction = asm_make_instruction("Foo", "Bar", "Doh", 1, NULL);
...
TEST(instruction_construction, make_instruction_spushi_takes_two_slots) {
    instruction *instruction = asm_make_instruction("SPUSHI", NULL, NULL, 0, NULL);
...
TEST(instruction_construction, make_instruction_call_takes_three_slots) {
    instruction *instruction = asm_make_instruction("CALL", NULL, NULL, 0, NULL);
...
TEST(instruction_construction, make_instruction_properly_offsets_based_on_preceding_instruction) {
    ...
    instruction->slots = 3;  // start this instruction at slot three
    instruction->offset = 3; // this instruction takes up three slots
...
TEST(code_generation, add_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("ADD", NULL, NULL, 1, NULL);
...
TEST(code_generation, sub_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SUB", NULL, NULL, 1, NULL);
...
TEST(code_generation, store_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("STA", NULL, NULL, 1, NULL);
...
TEST(code_generation, load_immediate_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("LDI", NULL, NULL, 1, NULL);
...
TEST(code_generation, load_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("LDA", NULL, NULL, 1, NULL);
...
TEST(code_generation, branch_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("BRA", NULL, NULL, 1, NULL);
...
TEST(code_generation, branch_if_zero_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("BRZ", NULL, NULL, 1, NULL);
...
TEST(code_generation, branch_if_positive_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("BRP", NULL, NULL, 1, NULL);
...
TEST(code_generation, input_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("INP", NULL, NULL, 1, NULL);
...
TEST(code_generation, out_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("OUT", NULL, NULL, 1, NULL);
...
TEST(code_generation, halt_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("HLT", NULL, NULL, 1, NULL);
...
TEST(code_generation, cob_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("COB", NULL, NULL, 1, NULL);
...
TEST(code_generation, dat_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("DAT", NULL, NULL, 1, NULL);
...
TEST(code_generation, spush_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SPUSH", NULL, NULL, 1, NULL);
...
TEST(code_generation, spop_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SPOP", NULL, NULL, 1, NULL);
...
TEST(code_generation, sdup_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SDUP", NULL, NULL, 1, NULL);
...
TEST(code_generation, sadd_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SADD", NULL, NULL, 1, NULL);
...
TEST(code_generation, ssub_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SSUB", NULL, NULL, 1, NULL);
...
TEST(code_generation, smax_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SMAX", NULL, NULL, 1, NULL);

    asm_gen_code_for_instruction(result, instruction);

    ASSERT_EQ(result->code[0], 925);
...
TEST(code_generation, smin_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SMIN", NULL, NULL, 1, NULL);

    asm_gen_code_for_instruction(result, instruction);

    ASSERT_EQ(result->code[0], 926);
...
TEST(code_generation, smul_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SMUL", NULL, NULL, 1, NULL);

    asm_gen_code_for_instruction(result, instruction);

    ASSERT_EQ(result->code[0], 927);
...
TEST(code_generation, sdiv_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SDIV", NULL, NULL, 1, NULL);

    asm_gen_code_for_instruction(result, instruction);

    ASSERT_EQ(result->code[0], 928);
...
TEST(code_generation, spushi_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("SPUSHI", NULL, NULL, 1, NULL);

    asm_gen_code_for_instruction(result, instruction);

    /// SPUSHI is a synthetic instruction that compiles down to a SPUSH and an LDI
    ASSERT_EQ(result->code[0], 920);
    ASSERT_EQ(result->code[1], 401);
...
TEST(code_generation, call_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("CALL", NULL, NULL, 1, NULL);

    asm_gen_code_for_instruction(result, instruction);

    /// CALL is a synthetic instruction that compiles down to a SPUSH and an LDI of the target address to jump to
    // and finally a CALL machine code (910)
    ASSERT_EQ(result->code[0], 920);
    ASSERT_EQ(result->code[1], 401);
...
TEST(code_generation, ret_instruction_generates_properly) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction = asm_make_instruction("RET", NULL, NULL, 1, NULL);
...
TEST(code_generation, instructions_next_to_one_another_generate_in_order_properly) {
    ...
    ASSERT_EQ(result->code[0], 920); // SPUSHI
    ASSERT_EQ(result->code[1], 401);
...
TEST(code_generation, labels_resolve_at_code_generation_time) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction1 = asm_make_instruction("LDA", NULL, "FOO", 0, NULL);
    instruction * instruction2 = asm_make_instruction("DAT", "FOO", NULL, 1, instruction1);
...
TEST(code_generation, bad_label_causes_error) {
    compilation_result *result = asm_make_compilation_result();
    instruction * instruction1 = asm_make_instruction("LDA", NULL, "BAR", 0, NULL);
    instruction * instruction2 = asm_make_instruction("DAT", "FOO", NULL, 1, instruction1);
